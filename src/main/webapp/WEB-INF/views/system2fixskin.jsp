		...
		<div class="order-block">
			...
			<p class="model-label transfer-label">
				...
				<c:if test="${user.isAdmin == 1}">
					<button id="btn-urge-${fixSkin.id}" class="btn btn-danger" onclick="urge(${fixSkin.operator.id}, '', this.id)">催一下</button>
				</c:if>
			</p>
...
<script>
	...
	function urge(receiverId, orderNo, btnId) {
		notification.send(receiverId, orderNo, "修皮肤及褶皱", btnId);
	}
