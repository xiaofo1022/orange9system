...
public class OrderVerifyImage {
	...
	private List<OrderFixedImageData> fixedImageDataList;
	...
	public List<OrderFixedImageData> getFixedImageDataList() {
		return fixedImageDataList;
	}
	public void setFixedImageDataList(List<OrderFixedImageData> fixedImageDataList) {
		this.fixedImageDataList = fixedImageDataList;
	}
