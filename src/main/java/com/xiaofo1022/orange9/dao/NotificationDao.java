...
public class NotificationDao {
  ...
  public void insertNotification(Notification notification) {
    Date now = new Date();
    int id = commonDao.insert("INSERT INTO NOTIFICATION (INSERT_DATETIME, UPDATE_DATETIME, SENDER_ID, RECEIVER_ID, MESSAGE) VALUES (?, ?, ?, ?, ?)", now, now,
        notification.getSenderId(), notification.getReceiverId(), notification.getMessage());
