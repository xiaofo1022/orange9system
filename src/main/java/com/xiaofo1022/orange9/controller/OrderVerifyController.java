...
public class OrderVerifyController {
	...
	@ResponseBody
	public CommonResponse setOrderVerifier(
	...
	@ResponseBody
	public CommonResponse setImageVerified(
			@PathVariable int fixedImageId, 
			HttpServletRequest request) {
	...
	@ResponseBody
	public CommonResponse setImageDenied(
			@RequestBody Denial denial,
