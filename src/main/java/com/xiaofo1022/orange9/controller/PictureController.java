...
public class PictureController {
  ...
  /*
   * private void openDeskFolder(File fileDir) { try { Desktop.getDesktop().open(fileDir); } catch
  ...
  @ResponseBody
  public CommonResponse saveOriginalPicture(@RequestBody PictureData pictureData, BindingResult bindingResult, HttpServletRequest request,
  ...
  @ResponseBody
  public CommonResponse saveFixSkinPicture(@RequestBody PictureData pictureData, BindingResult bindingResult, HttpServletRequest request,
      HttpServletResponse response) {
    try {
      if (postProductionDao.isSelectedPicture(pictureData.getOrderId(), pictureData.getFileName())) {
  ...
  @ResponseBody
  public CommonResponse saveFixBackgroundPicture(@RequestBody PictureData pictureData, BindingResult bindingResult, HttpServletRequest request,
      HttpServletResponse response) {
    try {
      if (postProductionDao.isSelectedPicture(pictureData.getOrderId(), pictureData.getFileName())) {
  ...
  @ResponseBody
  public CommonResponse saveCutLiquifyPicture(@RequestBody PictureData pictureData, BindingResult bindingResult, HttpServletRequest request,
      HttpServletResponse response) {
    try {
      if (postProductionDao.isSelectedPicture(pictureData.getOrderId(), pictureData.getFileName())) {
  ...
  @ResponseBody
  public CommonResponse uploadIndexPicture(@PathVariable String path, @PathVariable String picname, @RequestBody OrderTransferImageData transferImageData,
